...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ForumThreadFactory forumThreadFactory = new ForumThreadFactory();

        ArrayList<Sprint> sprintsInProject = new ArrayList<>();
        ArrayList<BacklogItem> projectBacklog = new ArrayList<>();

        User henkDeProductOwner = new User();

        Project avansProject = new Project("Avans Project", "Dit is een Avans project.",henkDeProductOwner, projectBacklog, sprintsInProject);
        ...
        Sprint sprint = new Sprint("Eerste Sprint", sprintStartDate, sprintEndDate, henkDeProductOwner, sprintFeedbackStrategy);
        ...
        ForumThread forumThread1 = forumThreadFactory.CreateForumThread(2,"Help het gaat verkeerd", "Het komt niet goed", backlogItem1);
        ...
        ForumThread forumThread2 = forumThreadFactory.CreateForumThread(2,"Help het gaat verkeerd", "Het komt niet goed", backlogItem1);
